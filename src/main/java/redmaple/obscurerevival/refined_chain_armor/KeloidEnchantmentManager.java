...
import redmaple.obscurerevival.vanilla_registry.Enchantments;
...
public class KeloidEnchantmentManager {
    ...
    private static int getKeloidCurrentStep(LivingEntity entity) {
        EntityAttributeInstance keloidInstance =
                entity.getAttributeInstance(CustomizedEntityAttributes.KELOID_ARMOR);
    ...
    private static int getKeloidEnchantedPiecesCount(LivingEntity entity) {
        ...
        var keloidEntry = enchantmentRegistry.getOptional(Enchantments.KELOID).orElse(null);
    ...
    private static void updateKeloidArmor(LivingEntity entity, double bonusValue) {
        EntityAttributeInstance keloidInstance = entity.getAttributeInstance(CustomizedEntityAttributes.KELOID_ARMOR);
