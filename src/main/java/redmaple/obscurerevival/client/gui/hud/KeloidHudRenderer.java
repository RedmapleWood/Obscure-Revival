...
public class KeloidHudRenderer implements HudElement {
    ...
    private static final Identifier KELOID_FULL = Identifier.of("obscure_revival", "hud/keloid_full");
    ...
    private static int getKeloidArmorValue(PlayerEntity player) {
        EntityAttributeInstance keloidInstance =
                player.getAttributeInstance(CustomizedEntityAttributes.KELOID_ARMOR);
